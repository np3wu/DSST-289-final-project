#############################################################################
# Settings and functions for working with the DSST 289 notes and assignments
# I may ask you to update this file, but please do not modify it directly!
#
# Date: 29 August 2023
# Adapted from Dr. Arnold's recommended settings
